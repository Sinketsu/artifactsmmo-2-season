	...
	default:
		...
		case '/': // Prefix: "/"
			...
			case 'a': // Prefix: "ac"
				...
				switch elem[0] {
				case 'c': // Prefix: "counts/create"
					origElem := elem
					if l := len("counts/create"); len(elem) >= l && elem[0:l] == "counts/create" {
						elem = elem[l:]
					} else {
						break
					}
				...
				case '/': // Prefix: "/"
					...
					case '/': // Prefix: "/achievements"
						...
						if len(elem) == 0 {
							...
							switch r.Method {
							case "GET":
								s.handleGetCharacterAchievementsCharactersNameAchievementsGetRequest([1]string{
									args[0],
								}, elemIsEscaped, w, r)
							default:
								s.notAllowed(w, r, "GET")
			...
			case 'l': // Prefix: "leaderboard"
				...
				if len(elem) == 0 {
					...
					switch r.Method {
					case "GET":
						s.handleGetLeaderboardLeaderboardGetRequest([0]string{}, elemIsEscaped, w, r)
					default:
						s.notAllowed(w, r, "GET")
					}
		...
		case '/': // Prefix: "/"
			...
			case 'c': // Prefix: "characters"
				...
				if len(elem) == 0 {
					...
					case "GET":
						...
						r.operationID = "get_all_characters_characters_get"
				...
				case '/': // Prefix: "/"
					...
					case '/': // Prefix: "/achievements"
						...
						if len(elem) == 0 {
							...
							switch method {
							case "GET":
								r.name = "GetCharacterAchievementsCharactersNameAchievementsGet"
								r.summary = "Get Character Achievements"
								r.operationID = "get_character_achievements_characters__name__achievements_get"
								r.pathPattern = "/characters/{name}/achievements"
								r.args = args
								r.count = 1
								return r, true
							default:
			...
			case 'g': // Prefix: "ge"
				...
				if len(elem) == 0 {
					...
					case "GET":
						...
						r.operationID = "get_all_ge_items_ge_get"
						r.pathPattern = "/ge"
						r.args = args
						r.count = 0
						return r, true
			...
			case 'l': // Prefix: "leaderboard"
				...
				if len(elem) == 0 {
					...
					switch method {
					case "GET":
						r.name = "GetLeaderboardLeaderboardGet"
						r.summary = "Get Leaderboard"
						r.operationID = "get_leaderboard_leaderboard_get"
